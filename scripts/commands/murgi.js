...
a("আমি জয় করলাম শুরু তর আম্মুর ভুদায় দিব হাত");
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি জয় এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি জয় এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 156000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ জয় এর পুত। জা ভাগ🤖")} , 39000);
